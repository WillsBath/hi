...
# ==============================================================
# 2. LOAD MODEL (Same as training)
# ==============================================================
num_classes = 4   # <<--- Change if needed (ex: ['MildDemented','ModerateDemented','NonDemented','VeryMildDemented'])
...
# ==============================================================
# 5. PROVIDE CLASS NAMES MANUALLY
# ==============================================================
class_names = ['MildDemented', 'ModerateDemented', 'NonDemented', 'VeryMildDemented']
# ↑ Change based on your dataset folder names


# ==============================================================
# 6. RUN PREDICTION ON ONE IMAGE
# ==============================================================
image_path = "/content/Alzheimer/test/MildDemented/26.jpg"   # <<-- PUT YOUR IMAGE PATH HERE
